...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-+7+)t*es4d9()crn_k5q$cigw4_3k$_b8)#tt5=vu_8-961&ez')
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',  # Move to top for proper CORS handling
